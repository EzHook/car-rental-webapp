...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-main">
      ...
      <section ref={testimonialsRef} className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg">
            Don&apos;t just take our word for it—read real experiences from our satisfied clients.
          </p>
        </div>
          ...
          {[
            {
              ...
              content: "The premium fleet exceeded my expectations. Booking was seamless, and the car was in immaculate condition. Highly recommend for business trips!",
              rating: 5,
            },
            {
              name: "Michael Chen",
              role: "Weekend Adventurer",
              content: "Rented an SUV for a weekend getaway. Best prices I could find, and the customer service was phenomenal. Will definitely use Rental Drive again.",
              rating: 5,
            },
            {
              name: "Emily Rodriguez",
              role: "Family Vacation Planner",
              content: "From start to finish, the experience was perfect. No hidden fees and a great selection of cars. The kids loved the spacious minivan we got.",
              rating: 4,
            }
          ].map((testimonial, idx) => (
            <div key={idx} className="bg-bg-secondary/80 backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:border-gold/40 hover:shadow-2xl hover:shadow-gold/20 hover:bg-bg-secondary transition-all duration-300">
