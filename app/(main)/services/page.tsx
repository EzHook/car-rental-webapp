    ...
    <div className="min-h-screen bg-bg-main text-white">
      ...
      <section className="relative bg-linear-to-br from-bg-main/70 via-bg-elevated/70 to-bg-main/70 border-b border-gold/20 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: "url('/cars/aboutCover5.jpg')" }}
        />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              <div
                key={idx}
                className="group relative bg-linear-to-br from-bg-elevated to-bg-main border border-gold/20 rounded-2xl p-8 hover:border-gold/50 transition-all duration-300 hover:shadow-xl hover:shadow-gold/10 hover:-translate-y-2"
              >
                {service.badge && (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="relative text-center">
                {idx < 2 && (
                  <div className="hidden md:block absolute top-16 left-1/2 w-full h-0.5 bg-linear-to-r from-gold/50 to-gold/20"></div>
                )}
                <div className="relative inline-flex items-center justify-center size-32 bg-linear-to-br from-gold/20 to-gold/5 border-2 border-gold rounded-full mb-6 text-gold">
      ...
      <section className="relative px-6 lg:px-16 py-20 border-t border-gold/20 overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-20"
          style={{ backgroundImage: "url('/cars/aboutCover4.jpg')" }}
        />
        <div className="relative z-10 bg-linear-to-br from-bg-main/80 via-bg-elevated/80 to-bg-main/80 backdrop-blur-sm">
          <div className="max-w-4xl mx-auto text-center py-20">
            <h2 className="text-3xl lg:text-5xl font-bold mb-6 text-white drop-shadow-2xl">
              Ready to Start Your Journey?
            </h2>
            <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto bg-black/30 backdrop-blur-sm rounded-2xl px-8 py-6">
